...
const Historias = () => {
  ...
  return (
      <>
    {isAuth && 
        <div className='mt-14 min-w-full min-h-[80px] border-b border-b-gray-600 flex items-center gap-2 px-2 overflow-x-auto overflow-y-hidden bg-[#ddd] dark:bg-black'>
            <div className='w-full min-h-[80px] bg-transparent top-0 left-0 overflow-x-scroll overflow-y-hidden flex items-center gap-4 pr-2'>
                <div className='min-w-[60px] max-w-[60px] min-h-[60px] max-h-[60px] border-2 border-[#f20069] border-dashed rounded-full cursor-pointer transition-opacity duration-200 overflow-hidden relative hover:opacity-60 first:ml-2 flex justify-center items-center' onClick={()=>{setUploadStoriesMenu(true)}}>
