...
const TextContentPost = ({postId ,deployTextPost, setDeployTextPost, description, userImg, username, stateComments, content, setContent, sendComment}) => {
  ...
  { deployTextPost &&  
    <>    
    <div className='w-full min-h-screen dark:text-white bg-[#ddd] dark:bg-black fixed inset-0 z-50 overflow-auto flex flex-col justify-between'>
        ...
        <div className='w-full min-h-[100px] px-2 flex flex-col justify-center pt-4'>
            <div className='pt-4 w-full min-h-[100px] bg-[#ddd] dark:bg-black flex justify-start items-start'>
                ...
                <div className='w-full min-h-[100px] bg-[#ddd] dark:bg-black dark:text-white px-4'>
                    <p>{username} {description + "."}</p>
                </div>
            </div>
            <p className='uppercase text-[#aaa] text-[11px] pb-4 font-bold'>21 de Enero de 2022</p>
        </div>
        <div className='pt-4 w-full min-h-[300px] px-2 bg-[#ddd] dark:bg-black flex justify-start items-start flex-col overflow-y-auto border-t border-gray-600'>
        ...
        <div className='w-full min-h-[50px] p-2 flex flex-row pb-4 static '>
